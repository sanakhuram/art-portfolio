...
export default function ContactSection() {
  ...
  return (
    ...
    text-white font-extrabold mb-4 tracking-tight leading-[1.05]`}
          ...
          <p
            className={`${body.className ?? body.variable} mb-3 text-white text-base sm:text-lg`}
          >
            I’m open for web development projects, collaborations, and UX/UI design work.
            Feel free to reach out!
          </p>
          <p
            className={`${body.className ?? body.variable} mb-2 text-white text-base sm:text-lg`}
          >
            Email: <strong>sana.khuram.baig@gmail.com</strong>
          </p>
          <p
            className={`${body.className ?? body.variable} text-white text-base sm:text-lg`}
          >
