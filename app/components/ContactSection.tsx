    ...
    Phone: <strong>+47 40140362</strong>
        ...
        <div className="md:w-1/2 flex flex-col gap-2 sm:gap-3 p-4 sm:p-6">
          <form onSubmit={handleSubmit} className="flex flex-col gap-2">
            <label
              className={`${body.className ?? body.variable} flex flex-col text-sm sm:text-base text-white`}
            >
              Name: *
              <input
                type="text"
                ...
                className="mt-1 px-2 py-1 rounded-md text-red-900 placeholder-white border border-white/50 bg-transparent w-70 focus:outline-none focus:border-dashed focus:border-white"
                required
              />
            </label>
